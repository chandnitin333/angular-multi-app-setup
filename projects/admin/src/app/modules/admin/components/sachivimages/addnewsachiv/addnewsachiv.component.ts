...
export class AddnewsachivComponent {
    ...
    constructor(private sachive: SachiveImagesService, private route: ActivatedRoute, private titleService: Title, private util: Util, private comman: CommanTypeService, private toast: ToastrService, private router: Router) { }
    ngOnInit(): void {
